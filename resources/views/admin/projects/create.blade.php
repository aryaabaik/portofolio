...
<div style="margin-bottom:2rem;">
    ...
    <h1 style="font-family:'Syne',sans-serif;font-size:1.5rem;font-weight:800;color:#f1f5f9;margin-bottom:0.25rem;">Tambah Project</h1>
    <p style="font-size:0.8125rem;color:#334155;">Isi detail project portfolio baru.</p>
</div>
    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="admin-card" style="display:flex;flex-direction:column;gap:1.25rem;margin-bottom:1rem;">
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" placeholder="Nama project kamu" required>
            </div>

            <div>
                <label>Deskripsi *</label>
                <textarea name="description" rows="4" placeholder="Deskripsi singkat project..." required>{{ old('description') }}</textarea>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                <div>
                    ...
                    <select name="category">
                        <option value="web"    {{ old('category') === 'web'    ? 'selected' : '' }}>Web App</option>
            ...
            <div>
                ...
                <input type="text" name="tech_stack" value="{{ old('tech_stack') }}" placeholder="Laravel, Vue.js, MySQL, Docker" required>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                ...
                <div>
                    ...
                    <input type="url" name="github_url" value="{{ old('github_url') }}" placeholder="https://github.com/user/repo">
                </div>
            </div>
